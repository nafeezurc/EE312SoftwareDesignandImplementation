...
#include "BST.h"			// Includes BST class and its functions

// Global Variables
extern BST<String> variables;		// variables is defined in StatementTree.h
...
public:
	...
	/********************************************************************************************************************
												  	 build
	build is a public function that builds an ExpressionTree by calling the recursiveBuild function.
	********************************************************************************************************************/
	void build(void)
	{
		root = recursiveBuild();
	...
	/********************************************************************************************************************
															evaluate
	evaluate is a public function that returns the integer value of an evaluated ExpressionTree.
	********************************************************************************************************************/
	int evaluate()
	{
